...
export interface SessionDatesSelectionProps {
...
/**
 * Компонент для выбора дат занятий
 * Следует Open/Closed Principle - компонент закрыт для изменения, но открыт для расширения
 * через пропсы
 */
export const SessionDatesSelection: React.FC<SessionDatesSelectionProps> = ({
  form,
  suggestedDates,
  useCustomDate,
  selectedDateValue,
